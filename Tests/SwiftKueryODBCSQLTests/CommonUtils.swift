...
func createConnection() -> ODBCSQLConnection! {
    ...
    */
    ...
    return ODBCSQLConnection(connectionParameters:connectionstring)
}
...
class CommonUtils {
    ...
    func getConnectionPool() -> ConnectionPool {
        ...
        pool = ODBCSQLConnection.createPool(connectionParameters: connectionstring, poolOptions: ConnectionPoolOptions(initialCapacity: 0, maxCapacity: 1))
        return pool!
    }
